...
module.exports.sockets = {
  ...
  ***************************************************************************/
  onDisconnect: function(session, socket) {
    ...
    User.findOne({socketId: socketId}, function(e, user) {
      if (!e && user) {
        MathRoomService.leaveOldRooms(user, socket, function(e) {
          if (e) {
            sails.log.info(e);
          }
        });             
  ...
  ***************************************************************************/
  ...
  authorization: false,
  // authorization: function authSocketConnectionAttempt(req, cb) {     
  //   console.log(req);
